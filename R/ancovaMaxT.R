#' It gives the test statistic value and critical value of Min-T test for testing homogeneity of treatment effects against ordered alternatives in one-way ANCOVA model
#'
...
#' }
#' Y=G2
#' ancovaMaxT(Y,X,k,q,0.05)
#' @export


ancovaMaxT<-function(Y,X,k,q,alpha)
{
