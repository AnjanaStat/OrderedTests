#' It gives the test statistic value and critical value of asymptotic Min-T test for testing homogeneity of treatment effects against ordered alternatives in one-way ANCOVA model
#'
...
#' }
#' Y=G2
#' ancovaAMinT(Y,X,k,q,0.05)
#' @export
ancovaAMinT<-function(Y,X,k,q,alpha)
{
